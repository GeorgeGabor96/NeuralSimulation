...
void constant_current_experiment() {
	...
	Callback* visu_1 = callback_visualize_layer_neurons_create(l1, ".\\constant_current_exp", 600, 200);
	Callback* visu_2 = callback_visualize_layer_neurons_create(l2, ".\\constant_current_exp", 600, 200);
	Callback* visu_3 = callback_visualize_layer_neurons_create(l3, ".\\constant_current_exp", 600, 200);
