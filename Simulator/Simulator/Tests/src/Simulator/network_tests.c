...
TestStatus network_compile_general_use_case_test() {
	...
	layer_add_input_layer(l3, l1, s_class, 1.0f, 1.0f);
...
TestStatus network_step_test() {
	...
	layer_add_input_layer(layer2, layer1, s_class, 1.0f, 1.0f);
	layer_add_input_layer(layer3, layer2, s_class, 1.0f, 1.0f);
...
TestStatus network_summary_test() {
	...
	layer_add_input_layer(l_inner_1, l_input_1, s_class, 1.0f, 1.0f);
	layer_add_input_layer(l_inner_1, l_input_2, s_class, 1.0f, 1.0f);
	
	layer_add_input_layer(l_inner_2, l_input_1, s_class, 1.0f, 1.0f);
	layer_add_input_layer(l_inner_2, l_input_2, s_class, 1.0f, 1.0f);
	layer_add_input_layer(l_inner_2, l_inner_1, s_class, 1.0f, 1.0f);

	layer_add_input_layer(l_output_1, l_inner_2, s_class, 1.0f, 1.0f);
	
	layer_add_input_layer(l_output_2, l_inner_1, s_class, 1.0f, 1.0f);
	layer_add_input_layer(l_output_2, l_inner_2, s_class, 1.0f, 1.0f);
